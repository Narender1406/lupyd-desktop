...
class NotificationHandler(private val context: Context) {
    ...
    fun showBundledNotification(other: String, me: String) {
        try {
            ...
            val notification = runBlocking {
                buildUserNotification(context, other, me)
            }
...
//            }
    ...
    private suspend fun buildUserNotification(ctx: Context, other: String, me: String): Notification {
        ...
        val messages = db.userMessageNotificationsDao().getFromUser(other, 6)
